# OpenMP ![GitHub repo size](https://img.shields.io/github/repo-size/xVenve/POpenMP) ![GitHub top language](https://img.shields.io/github/languages/top/xVenve/POpenMP)
